...
<body class="bg-light">
    <nav class="navbar navbar-expand-lg navbar-light bg-white mb-4 shadow-md">
        <div class="container">
            <a class="navbar-brand" href="/pasien">{{ env('APP_NAME') }}</a>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    <li class="nav-item">
                        <a class="nav-link active" aria-current="page" href="/pasien">Home</a>
                    </li>
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" href="/pasien" id="navbarDropdown" role="button"
